...
{
  /// <summary>
  /// Interaction logic for DialogFindReplace.xaml
  /// </summary>
  public partial class DialogFindReplace : Window
  {
    ...
    public DialogFindReplace(TextEditor editor)
    {
      InitializeComponent();
    ...
    private static DialogFindReplace theDialog = null;

    public static void ShowForReplace(TextEditor editor)
    {
      if(theDialog == null)
      {
        theDialog = new DialogFindReplace(editor);
