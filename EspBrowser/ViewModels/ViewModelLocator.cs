/*
  ...
  <Application.Resources>
      <vm:ViewModelLocator xmlns:vm="clr-namespace:EspBrowser"
                           x:Key="Locator" />
  </Application.Resources>
...
namespace EspBrowser.ViewModels
{
  ...
  public class ViewModelLocator
  {
    ...
    public ViewModelLocator()
    {
      ...
      SimpleIoc.Default.Register<DialogRenameViewModel>();
      SimpleIoc.Default.Register<DialogNodeInfoViewModel>();
